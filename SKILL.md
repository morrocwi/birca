...
`v1.9.0` (2026-07-09). Human-approved public, educational/research, non-commercial release. Full validation
history, known open gaps (human two-reviewer clinical-safety audit, full cross-model suite, one known
model-specific format-compliance issue), and legal terms are in this repository's `README.md`,
