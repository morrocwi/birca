...
**Current version: v1.4.0.** Human-reviewed and approved for this public, educational/research-only,
...
| File | Role |
|---|---|
| `SYSTEM_PROMPT.md` | The actual portable skill (v1.4.0) — paste this into any LLM's system prompt |
...
| `CHANGELOG.md` | Full version history, v1.0.0 → v1.4.0 |
